...
const HTML = require('../../src/languages/html');

asyncTest('Basic Document parsing', function() {
  let customSerialization;
  const htmlParser = new HTML();
...
asyncTest('Removal of Empty nodes', function() {
  let customSerialization;
  const htmlParser = new HTML();
  window.customSerialization = (customSerialization = htmlParser.parse(
    `\
...
asyncTest('Optional Closing tags', function() {
  let customSerialization;
  const htmlParser = new HTML();
  window.customSerialization = (customSerialization = htmlParser.parse(
    `\
...
asyncTest('Attribute Sockets', function() {
  let customSerialization;
  const htmlParser = new HTML();
  window.customSerialization = (customSerialization = htmlParser.parse(
    `\
...
asyncTest('Scoket empty attribute values', function() {
  let customSerialization;
  const htmlParser = new HTML();
  window.customSerialization = (customSerialization = htmlParser.parse(
    `\
...
asyncTest('Check overrides', function() {
  let customSerialization;
  const htmlParser = new HTML({
...
asyncTest('Trailing Space', function() {
  let customSerialization;
  const htmlParser = new HTML();
  window.customSerialization = (customSerialization = htmlParser.parse(
    `\
